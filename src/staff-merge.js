export function mergeStaff(psTeachers, localRows) {
  ...
  for (const teacher of psTeachers) {
    ...
    if (local) {
      staff.push({
        ...
        powerschool_school_id: local.powerschool_school_id ?? teacher.powerschool_school_id ?? null,
        active: local.active,
        synced: true,
        in_powerschool: true,
      ...
      staff.push({
        ...
        powerschool_school_id: teacher.powerschool_school_id ?? null,
        active: true,
        synced: false,
        in_powerschool: true,
        powerschool_room: teacher.room ?? null,
  ...
  for (const local of localRows) {
    ...
    staff.push({
      ...
      email: local.email,
      photo_url: local.photo_url,
      powerschool_school_id: local.powerschool_school_id ?? null,
      active: local.active,
      synced: true,
